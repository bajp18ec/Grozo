...
var sidebar = document.querySelector(".sidebar"); // btn.onclick = function () {
...
function initAdmin(socket) {
  ...
  function renderItems(items) {
    var parsedItems = Object.values(items); // console.log(parsedItems[0].item.name)
...
var addTocart = document.querySelectorAll('.add-to-cart'); // let cartCounter = document.querySelectorAll('#cartCounter')

function cartNum(res) {
  // console.log(res)
  var cartQuan = document.getElementById('cartCounter');
...
(0,_admin__WEBPACK_IMPORTED_MODULE_2__.initAdmin)(); // console.log("appjs connected")
// Change order status
